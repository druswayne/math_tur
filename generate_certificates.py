...
class CertificateGenerator:
    def __init__(self, overwrite=False, quality=40, certificate_quality=15, compression_mode=None):
        ...
        self.diploma_coords = {
            'place': {'start': (350, 443), 'end': (450, 443)},        # степень диплома (1–3)
            'name': {'start': (157, 579), 'end': (737, 579)},         # ФИО участника
            'group': {'start': (460, 609), 'end': (508, 609)},        # класс
            'school_line1': {'start': (158, 670), 'end': (738, 670)}, # первая строка школы
            'school_line2': {'start': (158, 717), 'end': (738, 717)}, # вторая строка школы
            'score': {'start': (492, 839), 'end': (537, 839)}         # баллы
        }
