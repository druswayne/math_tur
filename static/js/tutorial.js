class UserTutorial {
    constructor() {
        ...
        this.steps = [
            ...
            {
                title: "Общий счёт",
                description: "Баллы начисляются за правильные ответы на задания в турнирах.\nВ конце турнирного сезона у вас будет возможность обменять накопленные баллы на призы.\nНа вкладке «Турнирная таблица» вы сможете отслеживать своё место в рейтинге. Все участники распределены по классам.",
                target: '.balance-section',
                position: 'bottom'
            },
            {
                title: "Жетоны",
                description: "Жетоны необходимы для участия в турнирах. Один жетон даёт право на одно участие. Их можно приобрести за реальные деньги.",
            ...
            {
                title: "Лавка призов",
                description: "Здесь вы можете обменять баллы, заработанные в турнирах, на призы. Обмен доступен только по завершении турнирного сезона.",
                target: '.shop-btn',
                position: 'bottom'
            },
            {
